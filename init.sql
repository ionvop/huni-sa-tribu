...
CREATE TABLE "content" (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `user_id` INTEGER REFERENCES `users`(`id`), `title` TEXT, `category` TEXT, `tribe` TEXT, `description` TEXT, `file` TEXT, "is_archived" INTEGER DEFAULT 0, `time` TEXT DEFAULT (unixepoch()));
